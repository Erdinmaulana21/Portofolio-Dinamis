...
<html lang="en">
  ...
  <!-- Navigation Bar -->
  <nav class="navbar navbar-light sticky-top mb-5" style="background-color: #596e79;">
            <div class="container text-center">
                <span class="navbar-brand h1 p-2 fw-bold text-light">Erdin Maulana</span>
            </div>
        </nav>
...
<!-- Form Edit -->
  ...
  <div class="container">
            ...
            <h3 class="fw-bold text-light rounded text-center p-2" style="background-color:#596e79;">Form untuk Edit Profile</h3>
            ...
            <form action="editprofil.php" method="POST">
                <div class="card-body">
                      ...
                      <button class="btn mt-3 mb-3 btn-outline-primary" style="width: 100%;" name="editp" value="edit">Simpan Perubahan</button>
